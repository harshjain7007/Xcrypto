...
import { Box, Container, Radio, RadioGroup, HStack, VStack, Text, Image, StatLabel, Stat, StatNumber, StatArrow, StatHelpText, Badge, Progress, Button } from '@chakra-ui/react'
    ...
    <Container maxW={"container.xl"} pt={"80px"}>
      { loading ? (
        ...
        <>
          ...
          {
            btns.map((curElem) => 
              <Button key={curElem} onClick={()=>switchChartStats(curElem)}>{curElem}</Button>
            )
          }
          </HStack>
